...
class manageMetadata:
    ...
    @classmethod
    def stim_feats_from_meta(cls, crr_dict, num_segments, sampling_rate=None):
        ...
        try:
            ...
            if 'sampling_rate' in crr_dict:
                if crr_dict['sampling_rate'] != "unknown":
                ...
                r = sampling_rate
                logger.info("sampling rate calculated from ABF header")
