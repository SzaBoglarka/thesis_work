...
# Load data
with open('../PTI_PV_standard_features_MOUSE_expdata_FINAL_NEW/corrected_features.json') as f:
...
file_name_valid_data= 'standard_features_for_validation_MOUSE_FINAL.json'
json.dump(ordered_valid_data, open(file_name_valid_data, "w"), indent=4)

file_name_stim_data= '../stim_for_validation/stim_for_validation_MOUSE_FINAL.json'
json.dump(stim_data, open(file_name_stim_data, "w"), indent=4)

file_name_all_features= 'all_MOUSE_features.txt'
