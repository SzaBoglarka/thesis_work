...
# Load data
with open('../PTI_PV_standard_features_RAT_expdata_FINAL/features.json') as f:
...
file_name_valid_data= 'standard_features_RAT_ORIGINAL_STDS.json'
json.dump(ordered_valid_data, open(file_name_valid_data, "w"), indent=4)

#file_name_stim_data= '../stim_for_validation/stim_for_validation_RAT_ORIGINAL_STDS.json'
