...
def plot_isi_data_with_log_fit(cells_data, species, ax, x_length=None, color='blue',
    ...
    for i, isi_values in enumerate(isi_data_list):
        ...
        x_values = np.arange(1, len(isi_values) + 1)
...
plot_all = False
save_fig = f'./figures/MOUSE_vs_RAT_ISI_values_{current_type}_until_800ms_colorful_from_second_linear_fit_no_normalization.png'
