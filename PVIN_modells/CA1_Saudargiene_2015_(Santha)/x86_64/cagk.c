...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "k_ion");
 	...
 	ivoc_help("help ?1 mykca /home/szabobogi/BC_modells/CA1_Saudargiene_2015_(Santha)/cagk.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/szabobogi/BC_modells/CA1_Saudargiene_2015_(Santha)/cagk.mod";
static const char* nmodl_file_text = 
  "TITLE CaGk\n"
