...
#define ek ek_Kdrbwb
 double ek = -90;
#define gkdr gkdr_Kdrbwb
 double gkdr = 9;
#define phin phin_Kdrbwb
 double phin = 5;
 ...
 "gkdr_Kdrbwb", &gkdr_Kdrbwb,
 "ek_Kdrbwb", &ek_Kdrbwb,
 "phin_Kdrbwb", &phin_Kdrbwb,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 Kdrbwb C:/Users/DELL 111/Documents/Boglárka nagyon komoly mappája/Suli muri/TDK szakdoga stuff/Kosársejt modellek/Modell csupaszítás/CA1 modellek/CA1 Stacey 2009/kdrbwb.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "kdrbwb.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
  "//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%\n"
