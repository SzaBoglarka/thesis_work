...
#define ena ena_Nafbwb
 double ena = 55;
#define gna gna_Nafbwb
 double gna = 35;
#define phih phih_Nafbwb
 double phih = 5;
 ...
 "gna_Nafbwb", &gna_Nafbwb,
 "ena_Nafbwb", &ena_Nafbwb,
 "phih_Nafbwb", &phih_Nafbwb,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 Nafbwb C:/Users/DELL 111/Documents/Boglárka nagyon komoly mappája/Suli muri/TDK szakdoga stuff/Kosársejt modellek/Modell csupaszítás/CA1 modellek/CA1 Stacey 2009/nafbwb.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "nafbwb.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
  "//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%\n"
