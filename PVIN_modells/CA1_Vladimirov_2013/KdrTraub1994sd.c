...
#define nrn_init _nrn_init__Kdrsd
#define _nrn_initial _nrn_initial__Kdrsd
#define nrn_cur _nrn_cur__Kdrsd
#define _nrn_current _nrn_current__Kdrsd
#define nrn_jacob _nrn_jacob__Kdrsd
#define nrn_state _nrn_state__Kdrsd
#define _net_receive _net_receive__Kdrsd 
#define _f_rates _f_rates__Kdrsd 
#define rates rates__Kdrsd 
#define states states__Kdrsd 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_Kdrsd", _hoc_setdata,
 "rates_Kdrsd", _hoc_rates,
 0, 0
};
...
#define Vm Vm_Kdrsd
 double Vm = -65;
#define usetable usetable_Kdrsd
 double usetable = 1;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Kdrsd C:/Users/DELL 111/Documents/Boglárka nagyon komoly mappája/Suli muri/TDK szakdoga stuff/Kosársejt modellek/Modell csupaszítás/CA1 modellek/CA1 Vladimirov 2013/KdrTraub1994sd.mod\n");
...
static int _reset;
static char *modelname = "Delayed rectifier K current, for soma-dendrites compartments";
...
static int  _f_rates ( _threadargsprotocomma_ double _lv ) {
   double _lalphan , _lbetan , _lsmall ;
  _lsmall = ( 35.1 - ( _lv - Vm ) ) / 5.0 ;
   if ( fabs ( _lsmall ) > 1e-6 ) {
     _lalphan = 0.016 * ( 35.1 - ( _lv - Vm ) ) / ( exp ( ( 35.1 - ( _lv - Vm ) ) / 5.0 ) - 1.0 ) ;
     }
   else {
     _lalphan = 0.016 * 5.0 / ( 1.0 + _lsmall / 2.0 ) ;
     }
   _lbetan = 0.25 * exp ( ( 20.0 - ( _lv - Vm ) ) / 40.0 ) ;
   ninf = _lalphan / ( _lalphan + _lbetan ) ;
   ntau = 1.0 / ( _lalphan + _lbetan ) ;
     return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "KdrTraub1994sd.mod";
static const char* nmodl_file_text = 
