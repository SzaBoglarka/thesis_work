...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kapin C:/Users/DELL 111/Documents/Boglárka nagyon komoly mappája/Suli muri/TDK szakdoga stuff/Kosársejt modellek/Modell csupaszítás/CA3 modellek/CA3 Tzilivaki 2019/kaproxin.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "kaproxin.mod";
static const char* nmodl_file_text = 
