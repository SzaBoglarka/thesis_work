...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 kctin C:/Users/DELL 111/Documents/Boglárka nagyon komoly mappája/Suli muri/TDK szakdoga stuff/Kosársejt modellek/Modell csupaszítás/CA3 modellek/CA3 Tzilivaki 2019/kctin.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "kctin.mod";
static const char* nmodl_file_text = 
  "\n"
  "TITLE Kct current\n"
  "\n"
