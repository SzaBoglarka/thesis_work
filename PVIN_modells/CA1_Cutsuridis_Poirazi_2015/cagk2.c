...
#define nrn_init _nrn_init__cagk2
#define _nrn_initial _nrn_initial__cagk2
#define nrn_cur _nrn_cur__cagk2
#define _nrn_current _nrn_current__cagk2
#define nrn_jacob _nrn_jacob__cagk2
#define nrn_state _nrn_state__cagk2
#define _net_receive _net_receive__cagk2 
#define rate rate__cagk2 
#define state state__cagk2 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 cagk2 C:/Users/DELL 111/Documents/Boglárka nagyon komoly mappája/Suli muri/TDK szakdoga stuff/Kosársejt modellek/Modell csupaszítás/CA1 modellek/CA1 Cutsuridis & Poirazi 2015/cagk2.mod\n");
 ...
 v=_v;
{
  ...
  ek = _ion_ek;
 { error =  state();
 if(error){fprintf(stderr,"at line 60 in file cagk2.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "cagk2.mod";
static const char* nmodl_file_text = 
  "TITLE CaGk2\n"
