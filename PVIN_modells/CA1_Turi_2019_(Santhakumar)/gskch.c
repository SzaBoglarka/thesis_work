...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "tca_ion");
 	...
 	ivoc_help("help ?1 gskch C:/Users/DELL 111/Documents/Boglárka nagyon komoly mappája/Suli muri/TDK szakdoga stuff/Kosársejt modellek/Modell csupaszítás/CA1 modellek/CA1 Turi 2019 (Santhakumar)/gskch.mod\n");
