...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 lca /home/szabobogi/BC_modells/CA1_Turi_2019_(Santhakumar)/LcaMig.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/szabobogi/BC_modells/CA1_Turi_2019_(Santhakumar)/LcaMig.mod";
static const char* nmodl_file_text = 
