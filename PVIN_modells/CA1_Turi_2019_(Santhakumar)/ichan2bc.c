...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 8, "ks_ion");
 	...
 	ivoc_help("help ?1 ichan2bc C:/Users/DELL 111/Documents/Boglárka nagyon komoly mappája/Suli muri/TDK szakdoga stuff/Kosársejt modellek/Modell csupaszítás/CA1 modellek/CA1 Turi 2019 (Santhakumar)/ichan2bc.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "ichan2bc.mod";
static const char* nmodl_file_text = 
  "TITLE ichan2bc.mod  \n"
  " \n"
  "COMMENT\n"
