...
#define nrn_init _nrn_init__CaT4
#define _nrn_initial _nrn_initial__CaT4
#define nrn_cur _nrn_cur__CaT4
#define _nrn_current _nrn_current__CaT4
#define nrn_jacob _nrn_jacob__CaT4
#define nrn_state _nrn_state__CaT4
#define _net_receive _net_receive__CaT4 
#define castate castate__CaT4 
#define evaluate_fct evaluate_fct__CaT4 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_CaT4", _hoc_setdata,
 "evaluate_fct_CaT4", _hoc_evaluate_fct,
 0, 0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 CaT4 C:/Users/DELL 111/Documents/Boglárka nagyon komoly mappája/KOKI PV BC/Kosársejt modellek/Modell csupaszítás/CA1 modellek jó/CA1 Chiovinietal (Szabolcs) 2014/CaT4.mod\n");
...
static int  evaluate_fct ( _threadargsprotocomma_ double _lv ) {
   ...
   tau_h = ( 350.0 + 1.0 / ( exp ( ( _lv + shift + 46.0 ) / 4.0 ) + exp ( - ( _lv + shift + 405.0 ) / 50.0 ) ) ) / phi_h ;
    return 0; }
 ...
 v=_v;
{
  cai = _ion_cai;
  cao = _ion_cao;
 {   euler_thread(2, _slist1, _dlist1, _p, castate, _ppvar, _thread, _nt);
     if (secondorder) {
    int _i;
    for (_i = 0; _i < 2; ++_i) {
...
#if NMODL_TEXT
static const char* nmodl_filename = "CaT4.mod";
static const char* nmodl_file_text = 
  ...
  "	tau_h = ( 350 + 1.0 / ( exp((v+shift+46)/4) + exp(-(v+shift+405)/50) ) ) / phi_h\n"
  "}\n"
  "UNITSON\n"
  ;
#endif
