...
#define k1 k1_ch_KvCaB
 double k1 = 0.00048;
#define myshift myshift_ch_KvCaB
 double myshift = 25;
...
#define st st_ch_KvCaB
 ...
 "myshift_ch_KvCaB", &myshift_ch_KvCaB,
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 ch_KvCaB C:/Users/DELL 111/Documents/Boglárka nagyon komoly mappája/Suli muri/TDK szakdoga stuff/Kosársejt modellek/Modell csupaszítás/CA1 modellek/CA1 Lee et al. 2014/ch_KvCaB.mod\n");
...
double exp1 (  double _lk , double _ld , double _lv ) {
   double _lexp1;
 _lexp1 = _lk * exp ( - 2.0 * _ld * FARADAY * ( _lv - myshift ) / R / ( 273.15 + celsius ) ) ;
 ...
 v=_v;
{
  ...
  cai = _ion_cai;
 { error =  state();
 if(error){fprintf(stderr,"at line 81 in file ch_KvCaB.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
