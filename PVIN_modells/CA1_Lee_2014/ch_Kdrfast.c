...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "k_ion");
 	...
 	ivoc_help("help ?1 ch_Kdrfast C:/Users/DELL 111/Documents/Boglárka nagyon komoly mappája/Suli muri/TDK szakdoga stuff/Kosársejt modellek/Modell csupaszítás/CA1 modellek/CA1 Lee et al. 2014/ch_Kdrfast.mod\n");
...
static int _reset;
static char *modelname = "Kdrfast.mod  ";
 ...
 v=_v;
{
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 62 in file ch_Kdrfast.mod:\n	SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 } }}
