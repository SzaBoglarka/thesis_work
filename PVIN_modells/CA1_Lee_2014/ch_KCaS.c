...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "ca_ion");
 	...
 	ivoc_help("help ?1 ch_KCaS C:/Users/DELL 111/Documents/Boglárka nagyon komoly mappája/Suli muri/TDK szakdoga stuff/Kosársejt modellek/Modell csupaszítás/CA1 modellek/CA1 Lee et al. 2014/ch_KCaS.mod\n");
 ...
 v=_v;
{
  ...
  cai = _ion_cai;
 { error =  state();
 if(error){fprintf(stderr,"at line 55 in file ch_KCaS.mod:\n	SOLVE state\n"); nrn_complain(_p); abort_run(error);}
 } }}
