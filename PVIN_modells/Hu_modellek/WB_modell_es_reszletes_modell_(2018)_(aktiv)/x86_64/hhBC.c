...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 hhBC /home/szabobogi/BC_modells/Hu_modellek/WB_modell_es_reszletes_modell_(2018)_(aktiv)/hhBC.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/szabobogi/BC_modells/Hu_modellek/WB_modell_es_reszletes_modell_(2018)_(aktiv)/hhBC.mod";
static const char* nmodl_file_text = 
