...
#define nrn_init _nrn_init__syn2
#define _nrn_initial _nrn_initial__syn2
#define nrn_cur _nrn_cur__syn2
#define _nrn_current _nrn_current__syn2
#define nrn_jacob _nrn_jacob__syn2
#define nrn_state _nrn_state__syn2
#define _net_receive _net_receive__syn2 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
 	...
 	ivoc_help("help ?1 syn2 /home/szabobogi/BC_modells/Hu_modellek/WB_modell_es_reszletes_modell_(2018)_(aktiv)/syn2.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/szabobogi/BC_modells/Hu_modellek/WB_modell_es_reszletes_modell_(2018)_(aktiv)/syn2.mod";
static const char* nmodl_file_text = 
  ": Suffix syn2\n"
  "\n"
  "COMMENT\n"
