...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "ca_ion");
 	...
 	ivoc_help("help ?1 ch_CavN /home/szabobogi/BC_modells/CA1_Bezaire_2016_(Lee)/ch_CavN.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/szabobogi/BC_modells/CA1_Bezaire_2016_(Lee)/ch_CavN.mod";
static const char* nmodl_file_text = 
