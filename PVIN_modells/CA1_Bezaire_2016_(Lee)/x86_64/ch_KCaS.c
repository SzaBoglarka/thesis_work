...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "ca_ion");
 	...
 	ivoc_help("help ?1 ch_KCaS /home/szabobogi/BC_modells/CA1_Bezaire_2016_(Lee)/ch_KCaS.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/szabobogi/BC_modells/CA1_Bezaire_2016_(Lee)/ch_KCaS.mod";
static const char* nmodl_file_text = 
