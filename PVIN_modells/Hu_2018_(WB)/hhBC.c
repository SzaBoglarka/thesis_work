...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 hhBC C:/Users/DELL 111/Documents/Boglárka nagyon komoly mappája/KOKI PV BC/Kosársejt modellek/Modell csupaszítás/Hu modellek/WB modell (2018) (aktív)/hhBC.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "hhBC.mod";
static const char* nmodl_file_text = 
