...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 cagk C:/Users/DELL 111/Documents/Boglárka nagyon komoly mappája/KOKI PV BC/Kosársejt modellek/Modell csupaszítás/CA1 modellek jó/CA1 Migliore 2018 (HB)/cagk.mod\n");
