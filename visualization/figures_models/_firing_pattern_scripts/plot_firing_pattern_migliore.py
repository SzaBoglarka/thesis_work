...
model_name = "Migliore 2018"
h.nrn_load_dll('/home/szabobogi/BC_modells/CA1_Migliore_2018/x86_64/libnrnmech.so')
h.load_file('/home/szabobogi/BC_modells/CA1_Migliore_2018/cell_seed2_0-cnac-08.hoc')
save_dir = '../Migliore/'
cell = h.cNACnoljp2("/home/szabobogi/BC_modells/CA1_Migliore_2018/morphologies", "060314AM2.asc")
...
# run the simulation
h.fcurrent()
stim = h.IClamp(0.5, sec=h.cNACnoljp2[0].soma[0])
stim.amp = stim_amp
stim.delay = 200 * ms
stim.dur = 800 * ms
h.tstop = 1200 * ms
...
voltage_vector = h.Vector().record(h.cNACnoljp2[0].soma[0](0.5)._ref_v)
h.finitialize(-65 * mV)
#print("h.dt :", h.dt)
