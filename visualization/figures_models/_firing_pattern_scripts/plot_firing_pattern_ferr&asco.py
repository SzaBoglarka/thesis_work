...
model_name = "Ferrante & Ascoli 2015"
h.nrn_load_dll('/home/szabobogi/BC_modells/CA1_Ferrante_Ascoli_2015/x86_64/libnrnmech.so')
h.load_file('/home/szabobogi/BC_modells/CA1_Ferrante_Ascoli_2015/ffi.hoc')
save_dir = '../FerrAsco/'
#cell = h.pvbasketcell()
...
voltage_vector = h.Vector().record(h.soma[0](0.5)._ref_v)
h.finitialize(-65 * mV)
#print("h.dt :", h.dt)
