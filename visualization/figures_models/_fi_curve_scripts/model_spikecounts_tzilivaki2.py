...
h.load_file('/home/szabobogi/BC_modells/TzilivakiEtal_FSBCs_model/Multicompartmental_Biophysical_models/experiment/main_model_Somogyi_2.hoc')
save_dir = '../Tzilivaki.2/'
#cell = h.FScell()
...
for stim_amp in stimuli:
    ...
    rec_v = h.Vector().record(h.FScell[0].soma[0](0.5)._ref_v)
    h.run()
