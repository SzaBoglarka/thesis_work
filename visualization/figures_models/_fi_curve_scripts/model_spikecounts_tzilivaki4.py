...
h.load_file('/home/szabobogi/BC_modells/TzilivakiEtal_FSBCs_model/Multicompartmental_Biophysical_models/experiment/main_model_Somogyi_4.hoc')
save_dir = '../Tzilivaki.4/'
#cell = h.FScell()
