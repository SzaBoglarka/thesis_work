...
model_name = "Hu(rb) 2018"
h.nrn_load_dll('/home/szabobogi/BC_modells/Hu_modellek/WB_modell_es_reszletes_modell_(2018)_(aktiv)/x86_64/libnrnmech.so')
h.load_file('/home/szabobogi/BC_modells/Hu_modellek/WB_modell_es_reszletes_modell_(2018)_(aktiv)/test1_rb.hoc')
save_dir = '../Hu_rb/'
#cell = h.ICell()
