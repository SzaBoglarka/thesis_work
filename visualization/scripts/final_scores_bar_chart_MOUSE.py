...
base_dir= '/home/szabobogi/hippounit_standard_features/validation_results_MOUSE/results/'
# give save directory and save the figure(s)
save_dir= '/home/szabobogi/hippounit_standard_features/visualization/figures_MOUSE/Final_scores_barchart/'
if not os.path.exists(save_dir):
    os.makedirs(save_dir)
figname = 'final_scores_barchart_MOUSE'
...
"""
# separate the diff morphs if we iinclude saraga
...
plt.text(2.2, 8, 'point', fontsize = 12, color = color_chars)
plt.text(8.3, 8, 'stylized', fontsize = 12, color = color_chars)
plt.text(15.7, 8, 'detailed', fontsize = 12, color = color_chars)
